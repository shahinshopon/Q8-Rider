...
class HorseForSellScreen extends StatelessWidget {
   var data;
    HorseForSellScreen({required this.data});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(AppStrings.horsesForSale, style: AppStyles().appBarTextStyle),
        leading: IconButton(
            color: Colors.black,
            onPressed: () => Get.back(),
            icon: const Icon(
